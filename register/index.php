                                ...
                                <div class="form-heading">
                         		<center>Voter Registeration</center>
											...
											<div class="form-field">
												...
												<input class ="form-control" type = "text" name = "id_number" placeholder = "Student Roll No." required="true">
											...
											<div class="form-field">
												<label>Program of Study <i>(enter initials only i.e BCA,BBA,BSC..)</i></label><br/>
													<input class="form-control"  type = "text" name = "prog_study" placeholder="E.g BCA,BBA,BSC.." required="true">
											</div>
